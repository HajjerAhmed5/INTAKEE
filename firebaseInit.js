...
// Your Firebase config (public client keys are OK in frontend code)
const firebaseConfig = {
  ...
  measurementId: "G-PN4ZF9V347" // optional; only used if you add Analytics
};

// Avoid double-initialization (useful on Vercel previews / hot reload)
